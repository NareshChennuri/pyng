...
class ReportedcommentsController extends Helper_Controller_Admin {
	...
	public static function config() {
		return array(
			...
			'in_menu' => true,
			'permision_key' => 'reportedcomments',
			'sort_order' => 30507
		);
	}
	...
	public function indexAction() {
    	...
    	$this->view->categories = Model_Comments::getCommentReportCategories();
        ...
        $pins = Model_Comments::getCommentsR($data);
        ...
        $total_records = Model_Comments::getTotalCommentsR($data);
	...
	public function deleteAction() {
		...
		Model_Comments::deleteR($this->getRequest()->getPost('id'));
		}
	}
	...
	public function deleteMultiAction() {
		...
		if($action_check && is_array($action_check)) {
			foreach($action_check AS $record_id) {
				Model_Comments::deleteR($record_id);
			}
		}
		}
	}
